...
import com.example.friendster.DataStruucture.Feed;
        ...
        user_id = intent.getStringExtra("feed_uid");
            ...
            mUserDbRef.addValueEventListener(new ValueEventListener() {
                ...
                public void onCancelled(DatabaseError databaseError) {
                    ...
                    Toast.makeText(AnotherUserProfileActivity.this, "Some Error Occured", Toast.LENGTH_SHORT).show();
                            ...
                            if (taskSnapshot.getMetadata().getReference() != null) {
                                ...
                                result.addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        mUserDbRef.child("profile_image").setValue(downloadUrl[0].toString());
                                    }
                                });
                            }
                        }
